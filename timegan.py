...
def timegan (ori_data, parameters):
  ...
  def embedder (X, T):
    ...
    with tf.compat.v1.variable_scope("embedder", reuse = tf.compat.v1.AUTO_REUSE):
      ...
      H = tf.compat.v1.layers.dense(e_outputs, hidden_dim, activation=tf.compat.v1.sigmoid)     
    return H
  ...
  def recovery (H, T):   
    ...
    with tf.compat.v1.variable_scope("recovery", reuse = tf.compat.v1.AUTO_REUSE):       
      ...
      X_tilde = tf.compat.v1.layers.dense(r_outputs, dim, activation=tf.compat.v1.sigmoid) 
    return X_tilde
  ...
  def generator (Z, T):  
    ...
    with tf.compat.v1.variable_scope("generator", reuse = tf.compat.v1.AUTO_REUSE):
      ...
      E = tf.compat.v1.layers.dense(e_outputs, hidden_dim, activation=tf.compat.v1.sigmoid)     
    return E
  ...
  def supervisor (H, T): 
    ...
    with tf.compat.v1.variable_scope("supervisor", reuse = tf.compat.v1.AUTO_REUSE):
      ...
      S = tf.compat.v1.layers.dense(e_outputs, hidden_dim, activation=tf.compat.v1.sigmoid)     
    return S
